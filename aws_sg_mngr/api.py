...
class Api(object):
    ...
    def authorize_ingress(self, security_group, ingress_rule):
        ...
        response = self.client.authorize_security_group_ingress(
            ...
            ToPort=ingress_rule.to_port)  # The end of port range for the TCP and UDP protocols, or an ICMP/ICMPv6 code number. For the ICMP/ICMPv6 code number, use -1 to specify all codes.
